        ...
        await axios
            ...
            .then((response) => {
                if (response.data.isSuccess) {
                    ...
                    console.log("찜 목록 불러오기 실패", response.data.result);
            })
            .catch((e) => {
                console.log("error", e);
            });
                    ...
                    <div className="product-contents">
                        <div className="icons-btn">
                            ...
                            <HeartBtnPage
                                ...
                                like={
                                    likeList.findIndex(
                                        (i) => i.postResponse.pid === travel.pid
                                    ) === -1
                                        ? false
                                        : true
                                }
                        ...
                        <span className="product-title">{travel.p_title}</span>{" "}
