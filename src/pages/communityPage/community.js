...
//   const [starred, setStarred] = useState(Array(products.length).fill(false));
...
//                 </Link>
//                 <div
//                   className={`favorite-icon ${starred[index] ? "filled" : ""}`}
...
//                 {product.destination}import 한줄평
//                 </span>{" "}
//                 <span className="product-traveler">
//                   {product.name}강릉 3박 4일
//                 </span>
...
import button1 from "./images/Group 533.svg";
import button2 from "./images/Ellipse 7.svg";
